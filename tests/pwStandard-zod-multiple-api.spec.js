...
test.describe('Suite Zod Schema Petstore', async () => {
    ...
    test.fail('should validate the OpenAPI schema for GET findByStatus "pending" - FAIL', async ({ request, page }) => {
    ...
    test.fail('should validate the OpenAPI schema for GET findByStatus "available" Custom Issues Style - FAIL', async ({ request, page }) => {
        const findByStatusReq = await request.get(
